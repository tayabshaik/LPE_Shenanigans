...
document.getElementById("EnableDevMode").addEventListener("click", () => EnableDevMode("stag.dazn.com"));
document.getElementById("DisableDevMode").addEventListener("click", () => DisableDevMode("stag.dazn.com"));
